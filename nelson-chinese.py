...
def trans(sentence):
    translated = translator.translate(sentence, dest='zh-tw')
...
def increse_vol():
    ...
    if currentVolumeDb > -5.409796714782715:
        volhightxt = trans(
            "volume is more than 70 percent...please keep it below 70")
...
def gogo():
    ...
    # input is given manually we can convert it to be directly given by voice
    ss = int(input("Enter the seconds to sleep: "))
    time.sleep(ss)
